...
class PacketStat:
    ...
    def __init__(self, filename, outfile, count, time):
        ...
        print("Source IP, Dest IP, Source Port, Destination Port," + \
              "source mac, destination mac, Duration, Total Bytes," + \
              "Total Pkts, FlowsCount, TCPCount, UDPCount," + \
              "AvgBytes, AvgPackets, AvgTCPpackets, AvgUDPpackets," + \
...
class AllPacket:
    ...
    def __init__(self, filename, outfile):
        ...
        print("Source IP, Destination IP, Source Port, Destination Port," + \
              "source mac, destination mac, Duration, Bytes," + \
